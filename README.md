...
* Run `git clone https://github.com/Artyom-Borushko/js-assignments.git` from command line to download the repo.
...
```
* Open https://github.com/Artyom-Borushko/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
